...
- **Command:** `Rscript analysis/r/03_randomization/verify_campaign_locations.R <locations export>`
...
- **Export verified:** Google Ads Editor locations view, account 289-473-3923,
  md5 `f3f25a0e11b5419c355aa27d4fd80481` (file kept locally, not committed).
